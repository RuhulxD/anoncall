...
public class routes {
  ...
  public static final controllers.ReverseCallController CallController = new controllers.ReverseCallController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseCallController CallController = new controllers.javascript.ReverseCallController(RoutesPrefix.byNamePrefix());
